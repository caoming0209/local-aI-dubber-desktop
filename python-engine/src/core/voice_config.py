"""Voice configuration: maps voice_id to CosyVoice2 inference parameters."""


# CosyVoice2 supports these modes:
#   "zero_shot"  — clone from prompt audio (inference_zero_shot)
#   "instruct2"  — instruction-guided synthesis (inference_instruct2)
#   "cross_lingual" — cross-lingual synthesis with prompt audio
# NOTE: CosyVoice2 does NOT support "sft" mode (that's CosyVoice v1 only)
# NOTE: instruct_text must end with <|endofprompt|> for CosyVoice2
...
VOICE_CONFIGS = {
    ...
    "voice_male_01": {
        ...
        "mode": "instruct2",
        "speaker_id": None,
        "instruct_text": "用标准普通话朗读这段话。<|endofprompt|>",
    ...
    "voice_male_02": {
        ...
        "mode": "instruct2",
        "speaker_id": None,
        "instruct_text": "用低沉磁性的声音朗读这段话。<|endofprompt|>",
    ...
    "voice_female_01": {
        ...
        "mode": "instruct2",
        "speaker_id": None,
        "instruct_text": "用温柔清晰的女声朗读这段话。<|endofprompt|>",
    ...
    "voice_female_02": {
        ...
        "mode": "instruct2",
        "speaker_id": None,
        "instruct_text": "用甜美活泼的声音朗读这段话。<|endofprompt|>",
    ...
    "voice_emotional_01": {
        ...
        "mode": "instruct2",
        "speaker_id": None,
        "instruct_text": "用富有感染力的声音朗读这段话。<|endofprompt|>",
    ...
    "voice_emotional_02": {
        ...
        "mode": "instruct2",
        "speaker_id": None,
        "instruct_text": "用温柔细腻的声音朗读这段话。<|endofprompt|>",
    ...
    "voice_dialect_01": {
        ...
        "mode": "instruct2",
        "speaker_id": None,
        "instruct_text": "请用广东话说这句话。<|endofprompt|>",
    ...
    "voice_dialect_02": {
        ...
        "mode": "instruct2",
        "speaker_id": None,
        "instruct_text": "请用四川话说这句话。<|endofprompt|>",
...
def get_voice_config(voice_id: str) -> dict:
    ...
    if config:
        return config
    # Fallback: use instruct2 mode with default prompt
    return {
        "name": "默认女声",
        "mode": "instruct2",
        "speaker_id": None,
